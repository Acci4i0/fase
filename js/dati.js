      ...
      macchinari: [
        {
          ...
          galleria: [],
          immagine: 'img/su-grigio/SEZIONE-CENTRIFUGHE-FD.jpg',
          nome: 'Disoleatrici a ciclo continuo serie FD',
          sintesi: 'Umidità residua sotto il 2%, fino a 7.000 kg/h',
          placeholder: 'sezione della disoleatrice Fase serie FD: rotore conico interno, bocchettone di carico in alto e quadro laterale',
          descrizione: [
        ...
        },
        {
          ...
          galleria: [],
          immagine: 'img/su-grigio/FC.jpg',
          nome: 'Centrifughe asciugatrici serie FC',
          sintesi: 'Paniere estraibile per torneria e post galvanica',
          placeholder: 'sezione della centrifuga Fase serie FC a coperchio sollevato, con cesto interno e cilindro di apertura',
          descrizione: [
        ...
        },
        {
          ...
          galleria: [],
          immagine: 'img/su-grigio/FCV480.jpg',
          nome: 'Centrifughe asciugatrici serie FCV',
          sintesi: 'Cesto verticale compatto, vibrazioni ammortizzate',
          placeholder: 'centrifuga Fase serie FCV, corpo verticale blu con motore in asse e quadro a bordo macchina',
          descrizione: [
        ...
        },
        {
          ...
          galleria: [],
          immagine: 'img/su-grigio/imgDK.jpg',
          nome: 'Disoleatrici serie DK',
          sintesi: 'Cesto estraibile per cariche e spezzoni grandi',
          placeholder: 'disoleatrice Fase serie DK, fusto chiaro su supporti divaricati con motore alla base',
          descrizione: [
      ...
      macchinari: [
        {
          ...
          galleria: [],
          immagine: 'img/su-grigio/IMP-a-ciclo-continuo.jpg',
          ...
          placeholder: 'impianto Fase a ciclo continuo: tramoggia sopraelevata, centrifuga e quattro cassoni di raccolta',
          descrizione: [
        ...
        },
        {
          ...
          galleria: [],
          immagine: 'img/su-grigio/trattamento-truciolo-imp.jpg',
          nome: 'Impianti di trattamento trucioli metallici a paniere estraibile',
          sintesi: 'Più materiali trattati senza contaminazione',
          placeholder: 'impianto Fase a paniere estraibile: linea con portale di movimentazione sopra le stazioni di lavoro',
          descrizione: [
        ...
        },
        {
          ...
          galleria: [],
          immagine: 'img/su-grigio/IMP-a-paniere-estraibile2.jpg',
          ...
          placeholder: 'impianto Fase di asciugatura per ambiente galvanico: linea con portale e stazioni di carico dei panieri',
          descrizione: [
      ...
      macchinari: [
        {
          ...
          immagine: 'img/su-grigio/trituratore-orizzontale.jpg',
          nome: 'Trituratori ad asse orizzontale serie TR',
          sintesi: 'Asse orizzontale con espulsione brevettata',
          placeholder: 'trituratore Fase serie TR ad asse orizzontale, bocca di carico rettangolare e motore in asse',
          descrizione: [
        ...
        },
        {
          ...
          galleria: [],
          immagine: 'img/su-grigio/trituratori-verticali.jpg',
          nome: 'Trituratori ad asse verticale serie TRW',
          sintesi: 'Asse verticale per frantumazione gravosa',
          placeholder: 'trituratore Fase serie TRW ad asse verticale, rotore a coltelli in vista e motore laterale',
          descrizione: [
