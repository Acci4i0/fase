const DATI = {
  ...
  hero: [
    ...
    },
    {
      ...
      placeholder: 'quattro trituratori Fase affiancati: due ad asse orizzontale e due ad asse verticale con tramoggia di carico',
  ...
  sistemi: [
      ...
      macchinari: [
        {
          ...
          galleria: [],
          immagine: 'img/su-grigio/imp-continuo-serie.jpg',
        ...
        },
        {
          ...
          placeholder: 'impianto Fase a paniere estraibile: portale con pinza sopra le stazioni di centrifugazione, dietro la recinzione di protezione',
          descrizione: [
        ...
        },
        {
          ...
          galleria: [],
          immagine: 'img/su-grigio/imp-galvanico-serie.jpg',
          ...
          placeholder: 'impianto Fase di asciugatura per ambiente galvanico: linea con vasche, due centrifughe inox e ribaltatore per cassoni',
          descrizione: [
    ...
    },
    {
      ...
      copertinaPlaceholder: 'quattro trituratori Fase affiancati: due ad asse orizzontale e due ad asse verticale con tramoggia di carico',
      ...
      macchinari: [
        {
          ...
          immagine: 'img/su-grigio/tr-serie.jpg',
          nome: 'Trituratori ad asse orizzontale serie TR',
          sintesi: 'Asse orizzontale con espulsione brevettata',
          placeholder: 'trituratore Fase serie TR ad asse orizzontale, corpo blu con rotore a coltelli in vista e due motoriduttori in asse',
          descrizione: [
